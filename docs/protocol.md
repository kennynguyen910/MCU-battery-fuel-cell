...
| Timestamp | Internal frame reserves uint64_t microseconds; acquisition will supply timestamps; epoch/synchronization TBD |
...
not a portable wire format. Frame status defaults to zero and is preserved by the fake; no protocol
